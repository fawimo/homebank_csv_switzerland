...
file_pattern = "*account_statements*"
...
columns_to_drop = ["Original amount", "Original currency", "Tags", "Wise", "Spaces", "Exchange rate", "Subject", "Category"]
df_clean = df_raw.drop(columns=columns_to_drop)

## Format the CSV to Homebank format
df_final = df_clean.rename(columns={"Date": "date"})
...
file_name = f"/home/fabien/Statements/neon_{current_date}.csv"
